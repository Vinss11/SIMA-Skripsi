...
module.exports = (sequelize, DataTypes) => {
  class Dosen extends Model {
    static associate(models) {
      ...
      Dosen.hasMany(models.PreferensiPengujiSidang, {
        foreignKey: "dosen_id",
        as: "preferensiPengujiSidang",
      });
      ...
      Dosen.hasMany(models.SidangPenilaian, {
        foreignKey: "dosen_id",
        as: "sidangPenilaians",
      });

      Dosen.hasMany(models.SidangRevisiPersetujuan, {
        foreignKey: "dosen_id",
        as: "sidangRevisiPersetujuans",
      });
    }
  ...
  Dosen.init(
    {
      ...
      status_keaktifan: {
        type: DataTypes.ENUM("active", "study_permission", "inactive", "study_leave", "retired"),
        allowNull: false,
        defaultValue: "active",
      },
