...
module.exports = (sequelize, DataTypes) => {
  ...
  const specs = {
    ...
    MataKuliahAlias: ["MataKuliahAliases", {
      ...
      kode_program_studi: { ...string(false, 40), defaultValue: "INFORMATIKA" }, is_active: boolean(),
    }, [{ unique: true, fields: ["source_id", "kode_alias", "kode_program_studi"] }]],
    ...
    RiwayatMetodologiPenelitian: ["RiwayatMetodologiPenelitians", {
      ...
      effective_at: date(false), version: { ...integer(), defaultValue: 1 }, previous_version_id: integer(true),
