...
const checks = [
  ...
  ["approved_extension_without_assignment", `SELECT i.id, i.mahasiswa_id FROM "IzinLanjutSkripsis" i LEFT JOIN "PenetapanPembimbings" a ON a.id = i.penetapan_hasil_id WHERE i.status = 'approved' AND a.id IS NULL`],
